  ...
  "candidatos": [
    {
      ...
      "codigo_paralelo": "código paralelo se houver, ou null",
      "descricao": "nome/descrição técnica da peça (obrigatório)",
      "marca": "marca da peça, ou null",
      "fabricante": "fabricante da peça, ou null",
      ...
      "motores_compativeis": "motores compatíveis mencionados na fonte, ou null",
      "chassis_compativeis": "chassis compatíveis mencionados na fonte, ou null",
      "ano_inicial": "ano inicial de aplicação (número), ou null",
      "ano_final": "ano final de aplicação (número), ou null",
      "observacoes": "observações técnicas relevantes, ou null",
      "equivalencias": [
        { "fabricante": "Mahle", "codigo": "OC619" },
        { "fabricante": "Tecfil", "codigo": "PSL123" }
      ],
      "torque": "especificação de torque se houver, ou null",
      "quantidade_por_veiculo": "quantidade utilizada no veículo, ou null",
      "tipo_oleo": "tipo de óleo se aplicável, ou null",
      "quantidade_oleo": "quantidade de óleo se aplicável, ou null",
      "liquido_arrefecimento": "especificação de líquido de arrefecimento, ou null",
      "ferramentas_necessarias": "ferramentas especiais necessárias, ou null",
      "tempo_estimado": "tempo estimado de troca, ou null",
      "procedimentos_tecnicos": "resumo de procedimentos técnicos, ou null",
      "imagem_url": "URL de uma imagem clara da peça encontrada na fonte, ou null",
  ...
  const candidates = list
    ...
    .map((candidate) => {
      ...
      return {
        ...
        codigo_paralelo: candidate.codigo_paralelo ?? null,
        descricao: String(candidate.descricao),
        marca: candidate.marca ?? null,
        fabricante: candidate.fabricante ?? null,
        categoria: candidate.categoria ?? null,
        subcategoria: candidate.subcategoria ?? null,
        aplicacao: candidate.aplicacao ?? null,
        motores_compativeis: candidate.motores_compativeis ?? null,
        chassis_compativeis: candidate.chassis_compativeis ?? null,
        ano_inicial: typeof candidate.ano_inicial === "number" ? candidate.ano_inicial : null,
        ano_final: typeof candidate.ano_final === "number" ? candidate.ano_final : null,
        ...
        tipo_oleo: candidate.tipo_oleo ?? null,
        quantidade_oleo: candidate.quantidade_oleo ?? null,
        liquido_arrefecimento: candidate.liquido_arrefecimento ?? null,
        ferramentas_necessarias: candidate.ferramentas_necessarias ?? null,
        tempo_estimado: candidate.tempo_estimado ?? null,
        procedimentos_tecnicos: candidate.procedimentos_tecnicos ?? null,
        imagem_url: candidate.imagem_url ?? null,
      };
    });
